...
[] spawn {
	...
	while {true} do {
		...
		_setText ctrlSetStructuredText (parseText format ["BARRACKS STATS <br />FOOD %1  <br />AMMO %2  <br />FUEL %3  <br />..<br />SENTRIES %4",RGG_Barracks_Food, RGG_Barracks_Ammo, RGG_Barracks_Fuel, RGG_Barracks_Sentries]);
